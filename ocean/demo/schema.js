...
const KEY_PARAMS = new Set([
  ...
  'scatterColor', 'foamAmount', 'foamFill', 'foamCell',
  ...
  'sdSplashParticles', 'sdSplashSize', 'sdSplashOpacity', 'sdSplashLife',
  'sdSplashPulse', 'sdSplashLaunch', 'sdSplashExit', 'sdSplashLand',
...
export const SCHEMA = [
  ...
  },
  {
    group: 'Sea Dragon', items: [
      ...
      S('sdSplashParticles', 'Jump splash', 0, 3, 0.01),
      S('sdSplashSize', 'Jump splash size', 0.2, 3, 0.01),
      S('sdSplashOpacity', 'Jump splash opacity', 0, 2, 0.005),
      S('sdSplashLife', 'Jump splash lifetime (s)', 0.3, 4, 0.05),
      S('sdSplashPulse', 'Jump splash density', 0, 1.5, 0.01),
      S('sdSplashLaunch', 'Jump splash launch', 0, 3, 0.01),
      S('sdSplashExit', 'Jump-out particles', 0, 3, 0.01),
      S('sdSplashLand', 'Dive-in particles', 0, 3, 0.01),
