...
hash11.setLayout( { name: 'abyssal_hash11', type: 'float', inputs: [ { name: 'p', type: 'float' } ] } );
...
fbm2.setLayout( { name: 'abyssal_fbm2', type: 'float', inputs: [ { name: 'p', type: 'vec2' }, { name: 'oct', type: 'int' } ] } );
billow.setLayout( { name: 'abyssal_billow', type: 'float', inputs: [ { name: 'p', type: 'vec3' }, { name: 'oct', type: 'int' } ] } );
remap01.setLayout( { name: 'abyssal_remap01', type: 'float', inputs: [ { name: 'x', type: 'float' }, { name: 'lo', type: 'float' }, { name: 'hi', type: 'float' } ] } );
spread01.setLayout( { name: 'abyssal_spread01', type: 'float', inputs: [ { name: 'x', type: 'float' } ] } );
bayer4.setLayout( { name: 'abyssal_bayer4', type: 'float', inputs: [ { name: 'c', type: 'vec2' } ] } );
