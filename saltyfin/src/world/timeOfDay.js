...
const KEYS = [
  ...
  // --------------------------------------------------------------- sunrise --
  {
    ...
    fogColor: 0xC6C4CE, fogNear: 130, fogFar: 1550, hazeStrength: 0.60, horizonGlow: 0.80,
    waterShallow: 0x44BDBA, waterMid: 0x117A96, waterDeep: 0x06294C,
    waterAbsorption: V(0.44, 0.106, 0.066), waterScatter: 0x1A88A0,
  ...
  // --------------------------------------------------------------- morning --
  {
    ...
    fogColor: 0xBBDCEE, fogNear: 190, fogFar: 1700, hazeStrength: 0.54, horizonGlow: 0.52,
    waterShallow: 0x55D2C8, waterMid: 0x0E7F9C, waterDeep: 0x052B54,
    waterAbsorption: V(0.46, 0.110, 0.070), waterScatter: 0x1A94A8,
  ...
  // ------------------------------------------------------------------ day --
  {
    ...
    waterShallow: 0x5AD8CC, waterMid: 0x108699, waterDeep: 0x052C58,
    waterAbsorption: V(0.46, 0.108, 0.068), waterScatter: 0x1C9CAE,
    causticStrength: 1.0,
  ...
  // ------------------------------------------------------------ afternoon --
  {
    ...
    waterShallow: 0x4BC8C4, waterMid: 0x137890, waterDeep: 0x06294E,
  ...
  // --------------------------------------------------------------- golden --
  {
    ...
    waterAbsorption: V(0.47, 0.140, 0.098), waterScatter: 0x186C86,
  ...
  // --------------------------------------------------------------- sunset --
  {
    ...
    waterAbsorption: V(0.48, 0.155, 0.108), waterScatter: 0x125C74,
