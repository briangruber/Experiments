...
const KEYS = [
  ...
  // --------------------------------------------------------------- morning --
  {
    ...
    sun: { az: 66, el: 28 },
    sunColor: 0xFFEBC8, sunIntensity: 3.0,
    moonIntensity: 0.0,
    skyZenith: 0x1A6BD4, skyMid: 0x4B98E4, skyHorizon: 0xCDE8F8,
    sunDiscColor: 0xFFFBEC, sunHalo: 0xFFF4D8, sunHaloSize: 0.09,
    cloudLit: 0xFFFFFF, cloudShadow: 0xB0C6DE, cloudRim: 0xFFFFFF,
    cloudCover: 0.40,
    ambientSky: 0x9AC8EE, ambientGround: 0x2C6C78, ambientIntensity: 0.95,
    fogColor: 0xB2DCF2, fogNear: 220, fogFar: 1850, hazeStrength: 0.40, horizonGlow: 0.55,
    waterShallow: 0x5CDACE, waterMid: 0x21B4C0, waterDeep: 0x0B4A98,
    waterAbsorption: V(0.34, 0.075, 0.045), waterScatter: 0x1FA2B2,
  ...
  // ------------------------------------------------------------------ day --
  {
    hour: 12.0, key: 'day',
    sun: { az: 44, el: 66 },
    sunColor: 0xFFF6E2, sunIntensity: 3.7,
    skyZenith: 0x1361D2, skyMid: 0x3D8FE6, skyHorizon: 0xC6E7F8,
    ...
    ambientSky: 0xA2CEF2, ambientGround: 0x2E7280, ambientIntensity: 1.0,
    fogColor: 0xAADAF2, fogNear: 260, fogFar: 2000, hazeStrength: 0.34, horizonGlow: 0.48,
    waterShallow: 0x63E2D4, waterMid: 0x23BEC6, waterDeep: 0x0A4EA4,
    waterAbsorption: V(0.33, 0.07, 0.042), waterScatter: 0x22ACBC,
    causticStrength: 1.0,
    exposure: 1.0, bloomStrength: 0.30, bloomThreshold: 1.05,
    saturation: 1.13, contrast: 1.05, vignette: 0.22,
  },
  // ------------------------------------------------------------ afternoon --
  {
    hour: 16.2, key: 'afternoon',
    sun: { az: 56, el: 34 },
    sunColor: 0xFFEAC0, sunIntensity: 3.2,
    skyZenith: 0x1A69CE, skyMid: 0x5197DE, skyHorizon: 0xD8E4EE,
    sunHaloSize: 0.10, sunHalo: 0xFFEEC8,
    cloudLit: 0xFFF6EA, cloudShadow: 0xA8BCD6, cloudRim: 0xFFFAF0,
    cloudCover: 0.46,
    ambientSky: 0x9AC4EA, ambientGround: 0x2E6A74, ambientIntensity: 0.92,
    fogColor: 0xC0D8E8, fogNear: 200, fogFar: 1900, hazeStrength: 0.40, horizonGlow: 0.62,
    waterShallow: 0x53D2CC, waterMid: 0x1EA8BC, waterDeep: 0x0B4590,
    causticStrength: 0.95, sunGlitterColor: 0xFFF2D8,
    exposure: 1.0, bloomStrength: 0.38, bloomThreshold: 0.96,
    saturation: 1.14, vignette: 0.24,
  },
  // --------------------------------------------------------------- golden --
  {
