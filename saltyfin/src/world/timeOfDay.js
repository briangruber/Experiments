...
const KEYS = [
  ...
  // --------------------------------------------------------------- sunrise --
  {
    ...
    waterAbsorption: V(0.44, 0.118, 0.086), waterScatter: 0x1A88A0,
  ...
  // --------------------------------------------------------------- morning --
  {
    ...
    waterAbsorption: V(0.46, 0.122, 0.090), waterScatter: 0x1A94A8,
  ...
  // ------------------------------------------------------------------ day --
  {
    ...
    waterAbsorption: V(0.46, 0.120, 0.088), waterScatter: 0x1C9CAE,
    causticStrength: 1.0,
