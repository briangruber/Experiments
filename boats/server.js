...
//
// Serves the client out of ./public and runs the authoritative half of the
// simulation: monster spawning and AI, damage bookkeeping, gold, and the
// consequences of sinking. Boats are simulated on the clients that own them --
// this is a co-op hunting game, not a competitive one, so the server trusts a
// player's own position and only polices the numbers that matter (damage rate,
...
import {
  ...
  SINK_GOLD_PENALTY, xpForLevel, levelFromXp, monstersForDistance,
