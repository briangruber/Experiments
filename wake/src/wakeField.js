...
export class WakeField {
  constructor(renderer, size = 1024) {
    ...
    // Foam that LIVES on the water is not here any more: see surfaceState.js.
    // The field is the reconstruction -- waves and where the hull is working
    // -- and the surface state is what the water keeps afterwards.
