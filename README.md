...
| folder | what it is |
| --- | --- |
| `chicken-game/` | Chicken Game — a chicken coop and its outdoor run in three.js. Seven hens and a rooster run a weighted behavior AI with 60 states across two zones joined by a pop-hole door, under a day/night cycle they keep farm hours by: out all day, in at dusk, asleep on the roost at night. They hold a real pecking order — a standoff is decided by rank, the winner takes the spot a lower bird was eating from, and now and then the underdog wins and the two swap places for good. A hen can go broody and hatch a brood of chicks that trail after her. Reginald the rooster crows at first light, calls the hens over when he finds food, breaks up their fights and squares up to the fox. Presided over by Big Bertha, an enormous matriarch who mostly sleeps and does not fit through the door. Most nights a fox comes sniffing round the run: if the pop-hole was shut in time it leaves empty-handed, and if it wasn't it walks in and takes an egg — but shut the door too early and you lock chickens out in the dark with it. Weather runs on the same principle: when it starts raining the whole flock bolts for the door, and if you shut it first they crowd against it and get soaked. Toss seeds, drop a worm, send a hawk over, shoo the fox off, or pick a chicken up and put her down somewhere else. No text anywhere — thought bubbles and slapstick carry it. |
