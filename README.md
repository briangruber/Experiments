...
| folder | what it is |
| --- | --- |
| `chicken-game/` | Chicken Game — a chicken coop and its outdoor run in three.js. Seven hens and a rooster run a weighted behavior AI with 63 states across two zones joined by a pop-hole door, under a day/night cycle they keep farm hours by: out all day, in at dusk, asleep on the roost at night. It is, on inspection, a telenovela. Every bird holds a directed opinion of every other, seeded with history before you arrive and moved by what actually happens to them — shoved off the feed, evicted from the good nesting box, backed up in a fight, left off the guest list when the rooster calls his favourite over to food. Grudges decide who she picks a fight with; friendships decide who turns up to back her, and two against one beats rank. When something big happens a director takes the camera and shoots it like a soap: letterbox bars, a snap cut to her face, to his, to whoever is watching from the nesting boxes, and an organ sting over the top. That layer is local and cosmetic, so it can never desync a shared coop. They also hold a real pecking order, and it decides things — who backs down from a standoff, who gets shoved off the feed, who takes the high roosting bar and who goes over the edge of it at bedtime — and now and then the underdog wins and the two swap places for good. There are three identical nesting boxes and they all want the same one, so a hen will queue for it, glare at the occupant, and finally climb in on top of her. A hen can go broody and hatch a brood of chicks that trail after her. Reginald the rooster crows at first light, calls the hens over when he finds food, breaks up their fights and squares up to the fox. Presided over by Big Bertha, an enormous matriarch who mostly sleeps and does not fit through the door. Most nights a fox comes sniffing round the run: if the pop-hole was shut in time it leaves empty-handed, and if it wasn't it walks in and takes an egg — but shut the door too early and you lock chickens out in the dark with it. Weather runs on the same principle: when it starts raining the whole flock bolts for the door, and if you shut it first they crowd against it and get soaked. A mouse gets into the feed now and then, which is the one moment the flock remembers it is descended from dinosaurs; whoever catches it is chased by everyone else. Out in the run there is a butterfly, and no chicken has ever caught it. Toss seeds, drop a worm, send a hawk over, let a mouse in, shoo the fox off, or pick a chicken up and put her down somewhere else. No text anywhere — thought bubbles and slapstick carry it. |
